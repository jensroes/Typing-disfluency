...
pcol <- plot_grid(
  ...
  p.log + theme(legend.position="none", plot.margin = unit(c(.1, 0, .1, -.15), "cm")),
  align = 'h', nrow = 1,
  rel_widths = c(4,.5)
)
...
plot_grid(legend, pcol, ncol = 1, rel_heights = c(.1,1))
...
cowplot::plot_grid(p_beta, p_theta, p_scatter, p_param, align = "vh", labels = c("A", "B", "C", "D"), ncol=2, nrow = 2)
```
