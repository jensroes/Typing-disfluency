...
#---- 
# Load model
ark <- stan_model(file = "stanin/ARK_MoG.stan")
...
saveRDS(samps, 
        file = "stanout/ARK_MoG_posterior.rda",
        compress = "xz")
...
saveRDS(y_tilde, 
        file = "stanout/ARK_MoG_ytilde.rda",
        compress = "xz")
