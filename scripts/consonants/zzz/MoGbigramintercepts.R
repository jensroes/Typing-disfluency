...
#---- 
# Load model
mog <- stan_model(file = "stanin/MoGbigramintercepts.stan")
...
# Save model
saveRDS(m, 
        file = "stanout/consonants/MoGbigramintercepts.rda",
        compress = "xz")

# Traceplots
(param <- names(m)[!grepl("log_lik|y_tilde|u|w|n|lp__|lp_parts|log_theta|prob_tilde",names(m))])
