...
#---- 
# Load model
ark <- stan_model(file = "stanin/ARK.stan")
...
saveRDS(samps, 
        file = "stanout/ARK2_posterior.rda",
        compress = "xz")
