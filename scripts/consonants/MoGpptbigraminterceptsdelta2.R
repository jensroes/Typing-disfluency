...
#---- 
# Load model
mog <- stan_model(file = "stanin/MoGpptsbigraminterceptsdelta2.stan")

# Parameters to omit in output
omit <- c("theta", "log_theta", "u", "w", "mu", "prob_tilde", "lp_parts")
...
# Save model
saveRDS(m, 
        file = "stanout/consonants/MoGpptsbigraminterceptsdelta2.rda",
        compress = "xz")
